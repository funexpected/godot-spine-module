#ifndef SPINE_RUNTIME_3_6_H
#define SPINE_RUNTIME_3_6_H
#include "modules/spine/runtime/spine_runtime.h"

class SpineRuntime_3_6: public SpineRuntime {
    GDCLASS(SpineRuntime_3_6, SpineRuntime);

#ifdef SPINE_RUNTIME_CLASS
    spSkeleton* skeleton;
	spBone* root_bone;
