#ifndef SPINE_RUNTIME_4_0_H
#define SPINE_RUNTIME_4_0_H
#include "modules/spine/runtime/spine_runtime.h"

class SpineRuntime_4_0: public SpineRuntime {
    GDCLASS(SpineRuntime_4_0, SpineRuntime);
...
public:
    ...
    SpineRuntime_4_0(Ref<SpineResource> resource);
    ~SpineRuntime_4_0();
};
