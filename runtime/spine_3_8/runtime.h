#ifndef SPINE_RUNTIME_3_8_H
#define SPINE_RUNTIME_3_8_H
#include "modules/spine/runtime/spine_runtime.h"

class SpineRuntime_3_8: public SpineRuntime {
    GDCLASS(SpineRuntime_3_8, SpineRuntime);
...
public:
    ...
    SpineRuntime_3_8(Ref<SpineResource> resource);
    ~SpineRuntime_3_8();
};
